...
namespace InfiniteHopper
{
	...
	public class IPHGameController:MonoBehaviour 
	{
		...
		void UpdateScore()
		{
			...
			if ( scoreText )    scoreText.GetComponent<TextMeshProUGUI>().text = score.ToString();
		...
		IEnumerator GameOver(float delay)
		{
            ...
            (it, str) => {
				...
				gameOverCanvas.Find("TextScore").GetComponent<TextMeshProUGUI>().text = "得分 " + score.ToString();
				...
				gameOverCanvas.Find("TextHighScore").GetComponent<TextMeshProUGUI>().text = "最高分" + highScore.ToString();
			}
		}
